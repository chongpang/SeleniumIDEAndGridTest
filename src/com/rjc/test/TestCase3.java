...
public class TestCase3 {
  ...
  public TestCase3 (String platform, String browser, String version) {
  ...
  public void testCase3() throws Exception {
    driver.get(baseUrl + "/company/message/");
    driver.findElement(By.cssSelector("img.sp")).click();
    driver.findElement(By.cssSelector("#naviConsult > a > span")).click();
    driver.findElement(By.cssSelector("#lNav > li > a")).click();
    driver.findElement(By.cssSelector("a.hover > span")).click();
    driver.findElement(By.cssSelector("img.sp")).click();
  }
